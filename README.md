...
At this point, branched off from using the graphical configuration at https://configure.ergodox-ez.com/layouts/XMlB/latest/0 to maintain this as source code instead. Also to be able to add more features (like the keylogger) that just isn't possible to do with the graphical one.
